...
const daoMetadata = {
  ...
  experience: "Maintains consistent messaging aligned with DAO values and governance decisions",
  voiceHash: "",
  animationURI: "",
...
const learningDaoMetadata = {
  ...
  experience: "Learns optimal governance communication and community engagement strategies",
