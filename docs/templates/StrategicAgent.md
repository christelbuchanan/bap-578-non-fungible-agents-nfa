...
const strategicMetadata = {
  ...
  experience: "Maintains consistent monitoring parameters and alert thresholds",
  voiceHash: "",
  animationURI: "",
...
const learningStrategicMetadata = {
  ...
  experience: "Learns optimal monitoring strategies and predicts market trends and sentiment shifts",
